...
| `fact_sales` | 28,800 | Employee × month actuals (Lending, Investing, Banking Units, LEI) |
...
4. **LEI** — customer experience score (survey-based)
...
| LEI (customer experience) | 10% | 15% | 30% |
| Compliance / Risk | 15% | — | — |
...
*All data is synthetic. Dominion Trust is a fictional bank created for portfolio purposes.*
